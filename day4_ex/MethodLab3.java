...
public class MethodLab3 {
	...
	public static void main(String[] args) {
		...
		while (i < 5) {
			...
			System.out.println(num1 + "과 " + num2 + "의 차는 " + distance(num1, num2) + " 입니다.");
			i++;
		}
	}
 ...
 * 리턴
 * 
 * 3. main() 메서드에서는 1부터 30 사이의 난수 2 개를 추출하여 2번에서 구현된 메서드를 호출하고 리턴되는 결과를 가지고 다음과
 * 같은 형식으로 출력한다. "X 와 Y 의 차는 W 입니다." ----> 5회 반복
 * 
 * [ 실행 결과 ]
 * 
 * X 와 Y 의 차는 W 입니다. X 와 Y 의 차는 W 입니다. X 와 Y 의 차는 W 입니다. X 와 Y 의 차는 W 입니다. X 와 Y
 * 의 차는 W 입니다.
 */